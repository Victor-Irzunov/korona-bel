			...
			<div className='absolute sd:right-3 xz:-right-1 sd:top-9 xz:top-28 cursor-pointer'>
				...
				<nav>
					...
					<div className="flex justify-center items-center mt-6">
						<a href="https://www.instagram.com/salon_minitechniki" target="_blank" className='mx-2'>
						...
						<a href="viber://chat?number=%2B375293084904" target="_blank" className='mx-2' >
						...
						<a href="http://wa.me/375293084904?text=Нужна%20минитехника" target="_blank" className='mx-2'>
						...
						<a href='https://t.me/salon_mini_tehniki' className="pt-0.5 mx-1.5">
				...
				<aside className='my-6'>
					<p className=''>
						Закрытое акционерное общество "Дилерский центр Столичный НЭКСТ"
					</p>
					<p className=''>
						Юр.адрес: г. Минск,ул. Путейская, д.11/12, ком. 12
					</p>
					<p className=''>
						УНП 192745992
					</p>
					...
					<p className='mt-2 font-bold text-xl'>
						г.Минск, пр.Жукова 44, пом. 5-1, ТЦ "Аутлето"
					</p>
				</aside>
			</div>
