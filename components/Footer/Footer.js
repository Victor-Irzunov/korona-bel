		...
		<footer className="footer footer-center sd:pt-10 sd:pb-10 xz:pt-10 xz:pb-3 bg-base-200 text-base-content rounded" id='footer'>
			<div className='container mx-auto'>
				...
				<nav>
					...
					<div className="grid grid-flow-col gap-4 mt-6 xz:w-[60vw] sd:w-[15vw] mx-auto">
					...
					<div className='mt-8'>
						<a href='tel:80293084904' className='btn bg-orange-500 text-white border-4 border-orange-500 text-xl'>
							+375 29 308-49-04
						</a>
					</div>
				</nav>
