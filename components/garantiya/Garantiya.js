			...
			<div className='container mx-auto'>
				...
				<div className='mt-10'>
					<h5 className='text-orange-600 font-semibold text-2xl'>
						При покупке нашей техники мы предоставляем:
					</h5>
					...
					<div className='mt-7'>
						...
						<p className=''>
							Россия, 606104 Нижегородская обл., Павловский р-н, г. Павлово, ул. Аллея Ильича, 43, л.Ч, оф.2
						</p>
					</div>
					<div className='mt-4'>
						<p className='font-bold'>
						...
						<p className=''>
							Республика Беларусь,  г.Минск, пр.Жукова 44,5-1
						</p>
					</div>
				</div>
			</div>
